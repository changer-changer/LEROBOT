...
python src/lerobot/scripts/lerobot_record_tron2.py \
    ...
    --robot.cameras='{
        "cam_left": {"type": "intelrealsense", "serial_number_or_name": "427622272146", "fps": 30, "width": 640, "height": 480},
        "cam_right": {"type": "intelrealsense", "serial_number_or_name": "427622271245", "fps": 30, "width": 640, "height": 480},
        "cam_top": {"type": "intelrealsense", "serial_number_or_name": "244222301571", "fps": 30, "width": 640, "height": 480}
    }' \
    --robot.tactile_sensors='{
       "tac3d_sensor_l": {"type": "tac3d", "udp_port": 9989},
       "tac3d_sensor_r": {"type": "tac3d", "udp_port": 9988} 
    }' \
    --dataset.repo_id="deeptouchczx/tron2_peg_in_hole_cuboid3" \
    --dataset.root="/home/cuizhixing/data/outputs/start2026.3.23/tron2_peg_in_hole_cuboid3" \
    --dataset.fps=30 \
    --dataset.single_task="Insert the cuboid peg into the hole" \
    --dataset.video=true \
    --display_data=true

```

#   型号            序列号         Video号 (RGB)   USB 位置        位置
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   1   RealSense D40   427622272146   /dev/video6     usb-0000:00:1   左
       5                                              4.0-1.2
   2   RealSense D40   427622271245   /dev/video5     usb-0000:00:1   右
       5                                              4.0-1.1
   3   RealSense D45   244222301571   /dev/video17    usb-0000:00:1   上
       5                                              4.0-2


- **--robot.cameras**: 配置相机参数。注意：`LeRobot` 框架严格要求必须提供 `width` 和 `height`，请严格填写 `640` 和 `480`，以防内存中发生强制拉伸导致画面损坏或死机。
